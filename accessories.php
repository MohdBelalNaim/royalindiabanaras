...
<body>
    <section>
        <div class="hero-container text-light accessories">
            <div class="hero-title animate__animated animate__fadeInUp">Accessories</div>
            <div class="hero-description animate__animated animate__fadeInUp">We offer a wide range of accessories that will help you complete your outfit and make a style statement. Our collection includes everything from statement jewelry pieces to trendy bags and chic scarves. We understand the importance of accessories in enhancing the overall look, and hence we curate the best of the best for our customers.</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items" style="all:unset">Explore accessories</a></button></div>
        </div>
    </section>
