...
<body>
    <section>
        <div class="hero-container text-light ghagra">
            <div class="hero-title animate__animated animate__fadeInUp">The Gharara Store</div>
            <div class="hero-description animate__animated animate__fadeInUp">The Gharara is a traditional Indian dress that is popular in many parts of the
                country, especially in North India. It is a long, flowing skirt that is typically made of cotton, silk,
                or other lightweight fabrics, and is worn with a matching blouse and dupatta (a long scarf).</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items" style="all:unset">Explore ghararas</a></button></div>
        </div>
    </section>
