<?php
    ...
    $latest_products = "SELECT * from products order by id desc limit 4";
    $latest_res = mysqli_query($conn,$latest_products);
        ...
        <div class="product-container container">
            <?php
                while($row=mysqli_fetch_assoc($latest_res)){
                    ...
                    $name = strlen($row['name'])<10?$row['name']:substr($row['name'],0,20).'...';
                    $id = $row['id'];
                    $price = number_format($row['price']);
                    echo"
                    <div class='product-item'>
                        <div class='product-image-wrapper'>
                            <img src='./ribadmin/product-images/$images[0]' class='product-image'>
                        </div>
                        <div class='product-description'>
                            ...
                            <div class='product-actions'>
                                <button class='view'> <a href='details.php?id=$id' style='color:white;text-decoration:none;'><i class='bi bi-eye'></i> View</a></button>
    ...
    <section>
        ...
        <div class="container price-wrapper">
            <div class="price-item">
                <a href="price.php?price=599" style="all:unset">
                    <div class="price-title">Upto</div>
                    <div class="price-value">₹599</div>
                </a>
            </div>
            <div class="price-item">
                <a href="price.php?price=999" style="all:unset">
                    <div class="price-title">Upto</div>
                    <div class="price-value">₹999</div>
                </a>
            </div>
            <div class="price-item">
                <a href="price.php?price=1299" style="all:unset">
                    <div class="price-title">Upto</div>
                    <div class="price-value">₹1,299</div>
                </a>
            </div>
            <div class="price-item">
                <a href="price.php?price=2999" style="all:unset">
                    <div class="price-title">Upto</div>
