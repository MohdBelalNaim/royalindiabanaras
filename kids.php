...
<body>
    <section>
        <div class="hero-container text-light kids">
            <div class="hero-title animate__animated animate__fadeInUp">Kids</div>
            <div class="hero-description animate__animated animate__fadeInUp"> we offer a wide range of clothing options for children of all ages. Our collection includes comfortable and trendy pieces that are perfect for playtime, school, and special occasions. We understand the importance of keeping your child's comfort and style in mind while selecting their wardrobe, and hence we curate the best of both for our customers.</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items" style="all:unset">Explore kids wear</a></button></div>
        </div>
    </section>
