...
<body>
    <section>
        <div class="hero-container text-light kurta">
            ...
            <div class="hero-description animate__animated animate__fadeInUp">Royal India Banaras offers a wide range of women's kurta that
                is made from high-quality fabrics such as cotton, silk, and chiffon. Our collection includes both formal
                and casual kurta that are perfect for any occasion. We have a variety of designs ranging from simple and
                elegant to ornate and heavily embellished.</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items"
                        style="all:unset">Explore kurtas</a></button></div>
        </div>
    </section>
            ...
            <div class="product-item">
                ...
                <div class="product-description">
                    ...
                    <div class="product-actions">
                        <button class="view"> <a href="details.php" style="text-decoration:none;color:white;"><i class="bi bi-eye"></i> View</a></button>
