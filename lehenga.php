...
<body>
    <section>
        <div class="hero-container text-light lehenga">
            <div class="hero-title animate__animated animate__fadeInUp">The Lehenga Store</div>
            <div class="hero-description animate__animated animate__fadeInUp">Get a wide range of women's lehenga that is made from high-quality fabrics such as silk, georgette, and chiffon. Our collection includes both traditional and modern designs that are perfect for any occasion. We have a variety of designs ranging from simple and elegant to ornate and heavily embellished.</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items" style="all:unset">Explore lehengas</a></button></div>
        </div>
    </section>
