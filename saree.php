...
<body>
    <section>
        <div class="hero-container text-light saree">
            <div class="hero-title animate__animated animate__fadeInUp">The Saree Store</div>
            <div class="hero-description animate__animated animate__fadeInUp">Our saree collection includes various styles such as Banarasi, Kanjivaram, Chanderi, and Bandhani. We also offer a variety of colors and prints ranging from bold and bright to subtle and understated. Our saree designs feature intricate embroidery, prints, and embellishments that are perfect for festive occasions such as weddings, parties, and celebrations.</div>
            <div class="animate__animated animate__fadeInUp"><button class="explore-button"><a href="#items" style="all:unset">Explore sarees</a></button></div>
        </div>
    </section>

    <section>
    <div class="product-container container" id="items">
    ...
    <script>
        var mybutton = document.getElementById('sort-by');
